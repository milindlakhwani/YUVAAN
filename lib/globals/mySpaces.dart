...
class MySpaces {
  ...
  static const Widget vSmallGapInBetween = SizedBox(height: 15);
  static const Widget vGapInBetween = SizedBox(height: 25);
  ...
  static const Widget hSmallGapInBetween = SizedBox(width: 15);
  static const Widget hGapInBetween = SizedBox(width: 20);
